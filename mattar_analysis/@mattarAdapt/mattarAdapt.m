classdef mattarAdapt < handle
    ...
    methods
        ...
        % Constructor
        function obj = mattarAdapt(data,stimulus,tr,varargin)
            ...
            if isempty(p.Results.stimTime)
                ...
                % Create a set of stimTime vectors based upon the tr.
                for ii = 1:length(stimulus)
                    stimTime{ii}=0:tr:(size(stimulus{ii},1)-1)*tr;
                end
